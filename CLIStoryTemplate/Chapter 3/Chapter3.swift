...
func chapterThree(){
    ...
    var Charting: String? = "World Wide Fame"
    
    if let unwrappedCharting = Charting {
        print(" \(Character.self) has some highest charting us single's and a lot of \(unwrappedCharting).")
    } else {
        print(" \(Character.self) did not chart.")
        Charting = "Fame"
    }
